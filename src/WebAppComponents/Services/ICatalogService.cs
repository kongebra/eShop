...
namespace eShop.WebAppComponents.Services
{
    public interface ICatalogService
    {
        ...
        Task<CatalogResult> GetCatalogItems(int pageIndex, int pageSize, int? brand, int? type, decimal? minPrice = null, decimal? maxPrice = null);
        ...
        Task<CatalogPriceRange> GetPriceRange();
    }
}
